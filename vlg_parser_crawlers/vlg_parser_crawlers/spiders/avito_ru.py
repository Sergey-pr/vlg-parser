...
class AvitoSpider(scrapy.Spider):
    ...
    def __init__(self, **kwargs):
        ...
        self.url = 'https://www.avito.ru/volgograd/kvartiry/prodam-ASgBAgICAUSSA8YQ?district=2-3-9&f=ASgBAgECAUSSA8YQAUXgBxd7ImZyb20iOjUxMjQsInRvIjpudWxsfQ&pmax=2500000&s=104'
        self.page = 1
